...
grid = SingleClassifierEnhancer(
    ...
    options=[
        "-E", "ACC",
        "-search", "weka.core.setupgenerator.MathParameter", "-property", "cost",
        "-min", "-3.0", "-max", "3.0", "-step", "1.0", "-base", "10.0", "-expression", "pow(BASE,I)",
        # "-search", "weka.core.setupgenerator.MathParameter", "-property", "gamma",
        # "-min", "-3.0", "-max", "3.0", "-step", "1.0", "-base", "10.0", "-expression", "pow(BASE,I)",
        "-output-debug-info",
        "-initial-folds", "1", "-subsequent-folds", "1",
