...
INDIVIDUAL_SIZE = Arquivo.retorna_quantidade_colunas()
...
def count_individuals_relative_to_parent_average(population: list):
...
def get_duplicate_individuals_count(population: list):
