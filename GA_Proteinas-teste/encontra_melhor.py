...
class Encontra_melhor:
    ...
    def encontra_melhores_individuos(diretorio_resultados):
                    ...
                    with open(caminho_arquivo, 'r') as f:
                        for linha in f:
                            ...
                            if match:
                                ...
                                lista_individuos.append(bits)
        
        return lista_individuos

    def avalia_individuos(arquivo, lista_individuos, nome_class):
        resultados = []
...
def main():
    arquivo = Arquivo()
    arquivo.le_arquivo("BaseDepressao.csv")

    nome_class = 'Diagnostico_Depressao'
    diretorio_resultados = './Resultados_teste_Depressao'
